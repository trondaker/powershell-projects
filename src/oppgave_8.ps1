...
While ($min_hand -lt 17) {
    Write-Output "Trekker kort, fortsatt under 17."
...
if ($min_hand -gt 21) {
    Write-Output "Over 21, busted!"
} elseif ($min_hand -eq 21) {
    Write-Output "Jeg har blackjack!"
} elseif ($min_hand -lt 21) {
    Write-Output $min_hand
}
